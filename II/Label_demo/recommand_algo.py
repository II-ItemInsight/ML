...
# def gpt_based_similarity(products):
#     """
#     GPT를 사용하여 이름과 추천 점수를 기반으로 유사한 제품을 계산합니다.

#     Args:
#         products (list of dict): 각 상품의 이름과 추천 점수를 포함한 리스트.
#             예: [{"name": "Product A", "score": 280}, {"name": "Product B", "score": 260}]

#     Returns:
#         str: GPT가 반환한 유사 제품 목록.
#     """
#     # 상품 데이터를 자연어로 변환
#     product_list_text = "\n".join(
#         [f"- {p['name']}, 추천 점수: {p['score']}" for p in products]
#     )
...
#     각 상품별로 이름과 추천 점수를 고려하여 가장 유사한 제품을 순서대로 나열하세요.
#     """
...
# # 상품 데이터 예제
# products = [
#     {"name": "Product A", "score": 280},
#     {"name": "Product B", "score": 260},
#     {"name": "Product C", "score": 240}
# ]

# # GPT 호출
# result = gpt_based_similarity(products)
